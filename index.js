...
const wireSpecs = [
    { name: "1.6mm (白扁)", amp: 12, ref: "§25 表 25~5" },
    { name: "2.0mm (白扁)", amp: 15, ref: "§25 表 25~5" },
    { name: "2.0mm (單心)", amp: 19, ref: "§25 表 25~5" },
    { name: "3.5mm² (絞線)", amp: 19, ref: "§25 表 25~5" },
    { name: "5.5mm² (絞線)", amp: 25, ref: "§25 表 25~5" },
    { name: "8.0mm² (絞線)", amp: 33, ref: "§25 表 25~5" },
    { name: "14mm² (絞線)", amp: 50, ref: "§25 表 25~5" },
    { name: "22mm² (絞線)", amp: 60, ref: "§25 表 25~5" },
    { name: "30mm² (絞線)", amp: 75, ref: "§25 表 25~5" },
    { name: "38mm² (絞線)", amp: 85, ref: "§25 表 25~5" },
    { name: "50mm² (絞線)", amp: 100, ref: "§25 表 25~5" },
    { name: "60mm² (絞線)", amp: 115, ref: "§25 表 25~5" },
    { name: "80mm² (絞線)", amp: 140, ref: "§25 表 25~5" },
    { name: "100mm² (絞線)", amp: 160, ref: "§25 表 25~5" },
    { name: "125mm² (絞線)", amp: 190, ref: "§25 表 25~5" },
    { name: "150mm² (絞線)", amp: 220, ref: "§25 表 25~5" },
    { name: "200mm² (絞線)", amp: 260, ref: "§25 表 25~5" },
    { name: "250mm² (絞線)", amp: 300, ref: "§25 表 25~5" },
    { name: "325mm² (絞線)", amp: 345, ref: "§25 表 25~5" },
    { name: "400mm² (絞線)", amp: 390, ref: "§25 表 25~5" },
    { name: "500mm² (絞線)", amp: 450, ref: "§25 表 25~5" }
];
